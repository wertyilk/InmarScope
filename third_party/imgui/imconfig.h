...
// Enabled: the spectrum PSD line at large FFT sizes (32768/65536) exceeds 64K
// vertices; with 16-bit indices it overflowed and only the left half rendered.
// (Our GL 3.0 context can't use VtxOffset, so 32-bit indices is the fix.)
